...
final measureListOfColors = [Colors.red, Colors.black, Colors.orange,
  Colors.yellow, Colors.black, Colors.green,
...
final measureListOfDarkColors = [Colors.red[900], Colors.white, Colors.orange[900],
  Colors.yellow[900], Colors.white, Colors.green[900],
  Colors.blue[900], Colors.white, Colors.brown[900],
...
final measureListOfWidths = [96, 96, 72, 48, 48, 36, 24, 24, 18, 12, 12, 6, 6, 24, 24, 24, 24, 24, 24, 24];
final measureListOfDurations = [16, 16, 12, 8, 8, 6, 4, 4, 3, 2, 2, 1, 1, 4, 4, 4, 4, 4, 4, 4];
final measureListOfNames = ['whole', 'wholeRest','dotHalf',
  'half', 'halfRest', 'dotQuarter',
  'quarter', 'quarterRest', 'dotEighth',
...
final measureLabelArray = ['w', 'W', 'd', 'h', 'H', 'j', ' q', 'Q', 'i', 'e', 'E', 's', 'S', 'y', 'n', 'm', 'M', 'S³', '¾', 'o', 'Q'];
final measureListOfScales = [4.0, 4.0, 4.0, 4.0, 4.0, 4.0, 4.0, 4.0, 4.0, 4.0, 4.0, 2.0, 2.0, 3.0, 3.0, 3.0, 3.0, 3.0, 3.0, 3.0, 5.0];
...
final beatListOfColors = [Colors.blue, Colors.black, Colors.brown,
  Colors.deepOrange[800], Colors.black, Colors.amber[600], Colors.black,
  Colors.purple, Colors.grey, Colors.pink, Colors.tealAccent[100],
  Colors.lightGreenAccent[100], Colors.lightGreenAccent[400], Colors.indigo];

final beatListOfDarkColors = [Colors.blue[900], Colors.white, Colors.brown[900],
  Colors.red[900], Colors.white, Colors.amber[900], Colors.white,
  Colors.purple[900], Colors.grey[800], Colors.pink[900], Colors.tealAccent[400],
  Colors.lightGreenAccent[700], Colors.lightGreen[700], Colors.indigo[900]];
final beatListOfWidths = [80, 80, 60, 40, 40, 20, 20, 80, 80, 80, 80, 80, 80, 80, 80];
final beatListOfDurations = [4, 4, 3, 2, 2, 1, 1, 4, 4, 4, 4, 4, 4, 4];
final beatListOfNames = ['quarter', 'quarterRest', 'dotEighth',
  'eighth', 'eighthRest', 'sixteenth', 'sixteenthRest',
  'oneEAndA', 'oneAnd', 'oneAndA', 'oneEAnd', 'eAndA', 'oneEA', 'oneA'];
...
final beatLabelArray = [' q', 'Q','i','e','E', 's','S', 'y', 'n', 'm', 'M', 'S³', '¾', 'o'];
final beatListOfScales = [4.0, 4.0, 4.0, 4.0, 4.0, 4.0, 4.0, 4.0, 4.0, 4.0, 4.0, 4.0, 4.0, 4.0];
...
final threeFourListOfColors = [Colors.orange,
  Colors.yellow, Colors.black, Colors.green,
  Colors.blue, Colors.black, Colors.brown,
  Colors.deepOrange[800], Colors.black, Colors.amber[600], Colors.black,
  Colors.purple, Colors.grey, Colors.pink, Colors.tealAccent[100],
  Colors.lightGreenAccent[100], Colors.lightGreenAccent[400], Colors.indigo];
final threeFourListOfDarkColors = [Colors.orange[900],
  Colors.yellow[900], Colors.white, Colors.green[900],
  Colors.blue[900], Colors.white, Colors.brown[900],
  Colors.red[900], Colors.white, Colors.amber[900], Colors.white,
  Colors.purple[900], Colors.grey[800], Colors.pink[900], Colors.tealAccent[400],
  Colors.lightGreenAccent[700], Colors.lightGreen[700], Colors.indigo[900]];
final threeFourListOfWidths = [72, 48, 48, 36, 24, 24, 18, 12, 12, 6, 6, 24, 24, 24, 24, 24, 24, 24];
final threeFourListOfDurations = [12, 8, 8, 6, 4, 4, 3, 2, 2, 1, 1, 4, 4, 4, 4, 4, 4, 4];
final threeFourListOfNames = ['dotHalf',
  'half', 'halfRest', 'dotQuarter',
  'quarter', 'quarterRest', 'dotEighth',
  'eighth', 'eighthRest', 'sixteenth', 'sixteenthRest',
  'oneEAndA', 'oneAnd', 'oneAndA', 'oneEAnd', 'eAndA', 'oneEA', 'oneA'];
...
final threeFourLabelArray = ['d', 'h', 'H', 'j', ' q', 'Q', 'i', 'e', 'E', 's', 'S', 'y', 'n', 'm', 'M', 'S³', '¾', 'o', 'Q'];
final threeFourListOfScales = [4.0, 4.0, 4.0, 4.0, 4.0, 4.0, 4.0, 4.0, 4.0, 2.0, 2.0, 3.0, 3.0, 3.0, 3.0, 3.0, 3.0, 3.0, 5.0];
